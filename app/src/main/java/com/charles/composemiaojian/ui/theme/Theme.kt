...
fun ComposeMiaojianTheme(
    ...
    val bottomBar = animateColorAsState(targetColors.bottomBar, TweenSpec(1000))
    val background = animateColorAsState(targetColors.background, TweenSpec(1000))
    val listItem = animateColorAsState(targetColors.listItem, TweenSpec(1000))
    val divider = animateColorAsState(targetColors.divider, TweenSpec(1000))
    val chatPage  = animateColorAsState(targetColors.chatPage , TweenSpec(1000))
    val textPrimary  = animateColorAsState(targetColors.textPrimary , TweenSpec(1000))
    val textPrimaryMe  = animateColorAsState(targetColors.textPrimaryMe , TweenSpec(1000))
    val textSecondary  = animateColorAsState(targetColors.textSecondary , TweenSpec(1000))
    val onBackground  = animateColorAsState(targetColors.onBackground , TweenSpec(1000))
    val icon  = animateColorAsState(targetColors.icon , TweenSpec(1000))
    val iconCurrent  = animateColorAsState(targetColors.iconCurrent , TweenSpec(1000))
    val badge  = animateColorAsState(targetColors.badge , TweenSpec(1000))
    val onBadge  = animateColorAsState(targetColors.onBadge , TweenSpec(1000))
    val bubbleMe  = animateColorAsState(targetColors.bubbleMe , TweenSpec(1000))
    val bubbleOthers  = animateColorAsState(targetColors.bubbleOthers , TweenSpec(1000))
    val textFieldBackground  = animateColorAsState(targetColors.textFieldBackground , TweenSpec(1000))
    val more  = animateColorAsState(targetColors.more , TweenSpec(1000))
    val chatPageBgAlpha  = animateFloatAsState(targetColors.chatPageBgAlpha , TweenSpec(1000))
